...
shortFilmWindow.config([
  '$ionicConfigProvider', '$compileProvider', function($ionicConfigProvider, $compileProvider) {
...
shortFilmWindow.controller('notificationsCtrl', [
  '$rootScope', '$scope', 'App', 'PulltorefreshAPI', 'DetailsAPI', '$ionicLoading', '$stateParams', 'ParseNotificationService', 'Storage', '$timeout', function($rootScope, $scope, App, PulltorefreshAPI, DetailsAPI, $ionicLoading, $stateParams, ParseNotificationService, Storage, $timeout) {
...
shortFilmWindow.controller('genreCtrl', [
  '$rootScope', '$scope', 'App', 'PulltorefreshAPI', 'DetailsAPI', '$ionicLoading', '$stateParams', function($rootScope, $scope, App, PulltorefreshAPI, DetailsAPI, $ionicLoading, $stateParams) {
    ...
    $scope.init = function() {
      ...
      return $scope.objectToArray();
    };
    $scope.objectToArray = function() {
      $scope.genre = [];
      _.each($scope.genreobj, function(value, key, list) {
        return $scope.genre.push(value);
      });
